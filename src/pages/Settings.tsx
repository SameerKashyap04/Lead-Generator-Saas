      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
        <Card>
          <div className="text-center py-4">
            ...
            <h3 className="text-lg font-bold text-[var(--text-primary)]">LeadScaper Pro</h3>
            <p className="text-xs text-[var(--text-tertiary)] mt-1">By Devify · v1.0.0</p>
            <p className="text-xs text-[var(--text-secondary)] mt-2 max-w-md mx-auto mb-4">
              Extract high-quality business leads from Google Maps with powerful filtering, export tools, and lead management.
            </p>
            <div className="pt-4 border-t border-[var(--border-secondary)] flex flex-col items-center gap-3 text-xs text-[var(--text-tertiary)]">
              <div className="flex items-center gap-1">
                Made with <Heart size={12} className="text-red-400 fill-red-400" /> by Devify
              </div>
              <div className="flex flex-row flex-wrap items-center justify-center gap-4 text-[var(--text-secondary)]">
                <p>Email: <a href="mailto:contact@devify.co.in" className="text-brand-400 hover:underline">contact@devify.co.in</a></p>
                <p>Phone: <a href="tel:+918471897293" className="text-brand-400 hover:underline">+91 84718 97293</a></p>
                <p>Website: <a href="https://www.devify.co.in" target="_blank" rel="noopener noreferrer" className="text-brand-400 hover:underline">www.devify.co.in</a></p>
              </div>
            </div>
          </div>
        </Card>
