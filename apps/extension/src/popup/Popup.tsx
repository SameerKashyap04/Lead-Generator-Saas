...
import {
  ...
  Users, Mail, Globe, Sun, Moon, ChevronRight, LogOut
} from 'lucide-react';
...
export default function Popup() {
  ...
  useEffect(() => {
    ...
    // Load projects and sync
    import('@/services/sync').then(({ syncProjectsToCloud }) => {
      syncProjectsToCloud().then(() => {
  ...
  if (loading) {
    return (
      <div style={{ width: '360px', minHeight: '460px' }} className="bg-[var(--bg-primary)] flex items-center justify-center">
